  ...
  function renderProjects() {
    return projectsList.map(project => (
      <div key={project.name} className="project-div">
        <a href={project.source}><img src="screenshots/pomodorolight.jpg" alt="" /></a>
        <div>
          <h3><a className="project-title" target="_blank" href={project.source}>{project.name}<span>&#8594;</span></a></h3>
          <p>{project.description}</p>
          <div><button onClick={expandBox}>
          <svg width="125px" height="25px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" 
              xmlns="http://www.w3.org/2000/svg"
              stroke="#000000" stroke-width="0.00024">
